...
"""
After submitting my solution, I read through some of the discussions and found a
/much/ more ingenious solution using a dictionary with the keys as the compliment 
and the values as the original list index. This is my rewrite:
""" 
